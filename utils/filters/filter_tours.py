...
class FilterToursParams(BaseFilterParams):
    def __init__(
        ...
        duration_from: str = Query(None),
        duration_to: str = Query(None),
        category_id: int = Query(None),
        type_id: int = Query(None),
        accommodation_id: int = Query(None),
        age_group_from: int = Query(None),
        age_group_to: int = Query(None),
        is_one_day_tour: bool = Query(None),
        children_age_id: int = Query(None),
        activity_level_id: int = Query(None),
        language_id: int = Query(None),

        is_price_for_day: bool = Query(None),
