...
class FilterToursParams(BaseFilterParams):
    def __init__(
        ...
        rating: int | float | None = Query(None),
        ...
        age_group_from: int | None = Query(None),
        age_group_to: int | None = Query(None),
        is_one_day_tour: bool | None = Query(None),
        children_age_id: int | None = Query(None),
        activity_level_id: int | None = Query(None),
        language_id: int | None = Query(None),

        is_price_for_day: bool | None = Query(None),
