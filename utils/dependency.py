...
async def get_languages_services(uow: UOWDependency):
    return LanguagesService(uow)

async def get_tour_languages_services(uow: UOWDependency):
    return TourLanguagesService(uow)
