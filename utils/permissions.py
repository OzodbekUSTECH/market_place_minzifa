...
read_user = PermissionChecker("read_user")
...
read_role = PermissionChecker("read_role")
...
read_permission = PermissionChecker("read_permission")
...
read_mail = PermissionChecker("read_mail")
