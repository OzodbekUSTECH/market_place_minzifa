...
@router.get('', name="get list of roles", response_model=list[RoleSchema], dependencies=[Depends(read_roles)])
...
@router.post('', name="Create Role", response_model=RoleSchema, dependencies=[Depends(create_role)])
