...
async def create_support_question_answer(
    ...
    return await support_questions_service.create_support_question(question_data)
...
async def get_list_of_support_questions(
    ...
    return await support_questions_service.get_list_of_questions()
...
async def get_support_question_answer_by_id(
    ...
    return await support_questions_service.get_question_by_id(id)
...
async def update_support_qestion_answer(
    ...
    return await support_questions_service.update_question(id, question_data)

@router.delete('/{id}', response_model=IdResponseSchema)
async def delete_support_question_answer(
    id: int
):
    return await support_questions_service.delete_question(id)