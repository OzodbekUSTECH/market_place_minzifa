...
from schemas.tour_activities import (
    CreateTourActivitySchema,
    UpdateTourActivitySchema,
    TourActivitySchema,
)
...
async def create_tour_activity(
    ...
    tour_activities_service: Annotated[
        TourActivitiesService, Depends(get_tour_activities_services)
    ],
) -> TourActivitySchema:
